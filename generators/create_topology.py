...
TOPOLOGY = (
    ...
    ("eqx-fra", "Medium Fabric in Equinix Frankfurt", 65100, "ebgp-ebgp", "Frankfurt", "medium", "cisco", "172.16.0.0/23", "192.168.0.0/22", "10.1.0.0/16", "203.0.113.0/28"),
    ("eqx-chi", "Small Fabric in Equinix Chicago", 65200,"ospf-ibgp", "Chicago", "small", "arista","172.16.4.0/23", "192.168.4.0/22", "10.2.0.0/16")
)

TOPOLOGY_ELEMENTS = {
    # Topology [ Quantity, Device Role, Device Type, mtu, mlag support, is border]
    "eqx-chi": [
        ( 2, "spine", "CCS-720DP-48S-2F", 1500, False, True),
        ( 4, "leaf", "CCS-720DP-48S-2F", 1500, True, False),
    ],
    "eqx-fra": [
        ( 2, "spine", "N9K-C9364C", 9192, False, True), # spine as border
        ( 8, "leaf", "N9K-C93180YC-FX3", 9192, True, False),
    ],
}
